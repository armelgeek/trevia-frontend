...
function Footer({ 
  ...
  const socialLinks = [
    { icon: Facebook, href: "https://facebook.com/trevia-transport", label: "Facebook" },
    { icon: Twitter, href: "https://twitter.com/trevia-transport", label: "Twitter" },
    { icon: Instagram, href: "https://instagram.com/trevia-transport", label: "Instagram" },
    { icon: Linkedin, href: "https://linkedin.com/company/trevia-transport", label: "LinkedIn" },
    { icon: Youtube, href: "https://youtube.com/@trevia-transport", label: "YouTube" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-sm text-gray-400 mb-4 md:mb-0">
              © 2024 Trevia Transport. Tous droits réservés.
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm">contact@trevia-transport.com</span>
                </div>
                <div className="flex items-center space-x-3">
...
export function FooterSample() {
  return (
    <div className="space-y-8">
      <LabeledSection label="Footer Complet">
        <Footer variant="detailed" />
      </LabeledSection>

      <LabeledSection label="Footer Simple">
        <Footer variant="simple" showNewsletter={false} showStats={false} />
      </LabeledSection>

      <LabeledSection label="Footer Minimal">
        <Footer variant="minimal" />
      </LabeledSection>

      <LabeledSection label="Footer sans Newsletter">
        <Footer variant="detailed" showNewsletter={false} />
      </LabeledSection>

      <LabeledSection label="Footer sans Statistiques">
        <Footer variant="detailed" showStats={false} />
      </LabeledSection>
    </div>
  );
}
