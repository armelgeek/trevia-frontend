...
export function BookingFormSample() {
  return (
    <div className="space-y-8">
      <LabeledSection label="Formulaire de Recherche Complet">
      ...
      <LabeledSection label="Formulaire Simple">
      ...
      <LabeledSection label="Barre de Recherche Inline">
        <BookingForm 
          variant="inline"
          onSearch={(data) => console.log("Search data:", data)}
        />
